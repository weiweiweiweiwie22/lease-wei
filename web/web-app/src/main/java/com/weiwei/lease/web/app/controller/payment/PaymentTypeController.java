package com.weiwei.lease.web.app.controller.payment;


import com.weiwei.lease.common.result.Result;
import com.weiwei.lease.model.entity.PaymentType;
import com.weiwei.lease.web.app.service.PaymentTypeService;
...
public class PaymentTypeController {
    ...
    public Result<List<PaymentType>> list(@RequestParam Long id) {
        List<PaymentType> list = paymentTypeService.getTypesByRoomId(id);
