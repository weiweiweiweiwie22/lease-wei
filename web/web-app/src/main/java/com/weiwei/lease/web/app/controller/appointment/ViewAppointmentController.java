package com.weiwei.lease.web.app.controller.appointment;
...
public class ViewAppointmentController {
    ...
    public Result<List<AppointmentItemVo>> listItem() {
        List<AppointmentItemVo> list = viewAppointmentService.getAppointmentItemVo(LoginUserHolder.getLoginUser().getUserId());
