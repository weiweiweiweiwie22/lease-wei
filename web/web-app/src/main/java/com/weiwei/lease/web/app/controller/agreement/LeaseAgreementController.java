package com.weiwei.lease.web.app.controller.agreement;
...
public class LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        List<AgreementItemVo> list = leaseAgreementService.getAgreementItemVoByPhone(LoginUserHolder.getLoginUser().getUsername());
